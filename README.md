...
A full-stack React + FastAPI version with a human-in-the-loop review interface lives in [`lead-qualifier-ui/`](lead-qualifier-ui/). Same core logic, user-facing product.
---
## Project structure
