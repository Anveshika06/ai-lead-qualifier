...
The hardest part was not the LLM call — it was thinking through what happens when anything in the pipeline misbehaves: rate limits, deprecated models, malformed JSON, empty webhooks, edge-case leads. Production AI is mostly about handling the unhappy paths cleanly.

---

Built by Anveshika Kamble — MS Computer Science, University of Pittsburgh
